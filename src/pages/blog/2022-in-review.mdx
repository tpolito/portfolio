...
import dogImg from '/assets/roxy_and_evee.jpg';
import recapImg from '/assets/2022-recap-all.png';
...
- ✅ **Plan and stick to a personal budget** - This was a huge success. Despite some pretty big expenses, I was able to be much more mindful of my finances and keep better track of them.
- ❌ **Complete 180 Pixel Dailies** - I did twelve…
